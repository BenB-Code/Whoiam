  ...
  describe('setScreenSize', () => {
    const defaultState: Dictionary<WindowState> = {
      ...
      [PROJECTS]: {
        ...
        disableFullscreen: false,
        disableResize: false,
        position: { x: '7%', y: '10%', transform: 'none' },
        lastPosition: { x: '7%', y: '10%', transform: 'none' },
        size: { width: '61%', height: '90%' },
        lastSize: { width: '61%', height: '90%' },
        zIndex: 1,
        isActive: false,
      },
      [CONTACT]: {
    ...
    const mobileState: Dictionary<WindowState> = {
      [HOME]: {
        ...
        lastSize: { width: '100%', height: 'auto' },
        zIndex: 2,
        isActive: true,
      },
      [EXPERIENCES]: {
