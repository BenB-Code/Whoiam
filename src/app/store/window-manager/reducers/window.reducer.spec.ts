  ...
  describe('setScreenSize', () => {
    const defaultState: Dictionary<WindowState> = {
      [HOME]: {
        ...
        lastSize: { width: '64%', height: 'fit-content' },
        zIndex: 2,
        isActive: true,
      },
      [EXPERIENCES]: {
      ...
      [PROJECTS]: {
        ...
        lastSize: { width: '90%', height: 'fit-content' },
        zIndex: 1,
        isActive: false,
      },
      [CONTACT]: {
        ...
        lastSize: { width: '30%', height: 'fit-content' },
        zIndex: 1,
        isActive: false,
      },
    };
    const tabletState: Dictionary<WindowState> = {
      [HOME]: {
        ...
        disableFullscreen: false,
        disableResize: false,
        position: { x: '0%', y: '0%', transform: 'none' },
        lastPosition: { x: '0%', y: '0%', transform: 'none' },
        size: { width: '85%', height: 'fit-content' },
        lastSize: { width: '85%', height: 'fit-content' },
        zIndex: 2,
        isActive: true,
      },
      [EXPERIENCES]: {
      ...
      [PROJECTS]: {
        ...
        disableFullscreen: true,
        disableResize: false,
        position: { x: '2%', y: '2%', transform: 'none' },
        lastPosition: { x: '2%', y: '2%', transform: 'none' },
        size: { width: '78%', height: 'fit-content' },
        lastSize: { width: '78%', height: 'fit-content' },
        zIndex: 1,
        isActive: false,
      },
      [CONTACT]: {
        ...
        disableFullscreen: true,
        disableResize: false,
        position: { x: '45%', y: '7%', transform: 'none' },
        lastPosition: { x: '45%', y: '7%', transform: 'none' },
        size: { width: '50%', height: 'fit-content' },
        lastSize: { width: '50%', height: 'fit-content' },
        zIndex: 1,
        isActive: false,
      },
    };
    const mobileState: Dictionary<WindowState> = {
      [HOME]: {
        ...
        lastSize: { width: '100%', height: 'fit-content' },
        zIndex: 2,
        isActive: true,
      },
      [EXPERIENCES]: {
  ...
  describe('windows state modifications', () => {
    ...
    describe('openWindow', () => {
      ...
      it('should use defaultValues position and size when currentWindow has none', () => {
        ...
        expect(newState.entities[EXPERIENCES]?.position).toEqual({ x: '4%', y: '12%', transform: 'none' });
      ...
      it('should MINIMIZED when already MAXIMIZED', () => {
        ...
        expect(newState.entities[PROJECTS]).toEqual({
          ...
          disableFullscreen: false,
          disableResize: true,
          position: { x: '0%', y: '0%', transform: 'translate(0%, 0%)' },
          lastPosition: { x: '0%', y: '0%', transform: 'translate(0%, 0%)' },
          size: { width: '100%', height: 'fit-content' },
          lastSize: { width: '100%', height: 'fit-content' },
          zIndex: 4,
          isActive: false,
